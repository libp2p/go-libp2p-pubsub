...
func TestScoreMeshMessageDeliveries(t *testing.T) {
	...
	synctestTest(t, func(t *testing.T) {
		...
		ps := newPeerScore(params, slog.Default())
		for _, p := range peers {
			ps.OnNewOutboundStream(p, "myproto")
			ps.Graft(p, mytopic)
		}
...
func TestScoreMeshMessageDeliveriesDecay(t *testing.T) {
	...
	synctestTest(t, func(t *testing.T) {
		...
		// advance time so meshMessageDeliveriesActive becomes true (meshTime > activation)
...
func TestScoreRejectMessageDeliveries(t *testing.T) {
	...
	synctestTest(t, func(t *testing.T) {
		...
		ps := newPeerScore(params, slog.Default())
		ps.OnNewOutboundStream(peerA, "myproto")
		ps.OnNewOutboundStream(peerB, "myproto")
...
func TestScoreRetention(t *testing.T) {
	...
	synctestTest(t, func(t *testing.T) {
		...
		ps.OnClosedOutboundStream(peerA)
