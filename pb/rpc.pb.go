...
type ControlExtensions struct {
	...
	TopicStreams  *bool `protobuf:"varint,6492435,opt,name=topicStreams" json:"topicStreams,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TopicRPC) GetPublish() *Message {
	if x != nil {
...
type TopicRPC_Publish struct {
	Publish *Message `protobuf:"bytes,1,opt,name=publish,oneof"`
}
...
var file_rpc_proto_goTypes = []any{
	...
	(*TopicRPC)(nil),                 // 13: pubsub.pb.TopicRPC
	(*RPC_SubOpts)(nil),              // 14: pubsub.pb.RPC.SubOpts
}
var file_rpc_proto_depIdxs = []int32{
	14, // 0: pubsub.pb.RPC.subscriptions:type_name -> pubsub.pb.RPC.SubOpts
	...
	1,  // 12: pubsub.pb.TopicRPC.publish:type_name -> pubsub.pb.Message
