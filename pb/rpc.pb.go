...
func (x *RPC) GetSpread() *SpreadExtension {
	if x != nil {
		return x.Spread
	}
	return nil
...
func (x *ControlExtensions) GetSpread() bool {
...
func (x *SpreadExtension) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpreadExtension) ProtoMessage() {}

func (x *SpreadExtension) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpreadExtension.ProtoReflect.Descriptor instead.
...
var file_rpc_proto_goTypes = []any{
	...
	(*SpreadExtension)(nil),          // 12: pubsub.pb.SpreadExtension
	(*RPC_SubOpts)(nil),              // 13: pubsub.pb.RPC.SubOpts
}
var file_rpc_proto_depIdxs = []int32{
	13, // 0: pubsub.pb.RPC.subscriptions:type_name -> pubsub.pb.RPC.SubOpts
	...
	12, // 5: pubsub.pb.RPC.spread:type_name -> pubsub.pb.SpreadExtension
	3,  // 6: pubsub.pb.ControlMessage.ihave:type_name -> pubsub.pb.ControlIHave
	4,  // 7: pubsub.pb.ControlMessage.iwant:type_name -> pubsub.pb.ControlIWant
	5,  // 8: pubsub.pb.ControlMessage.graft:type_name -> pubsub.pb.ControlGraft
	6,  // 9: pubsub.pb.ControlMessage.prune:type_name -> pubsub.pb.ControlPrune
	7,  // 10: pubsub.pb.ControlMessage.idontwant:type_name -> pubsub.pb.ControlIDontWant
	8,  // 11: pubsub.pb.ControlMessage.extensions:type_name -> pubsub.pb.ControlExtensions
	9,  // 12: pubsub.pb.ControlPrune.peers:type_name -> pubsub.pb.PeerInfo
