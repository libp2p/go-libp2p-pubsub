...
type TraceEvent_RPCMeta struct {
	...
	MillisecondsToReceive *uint64                   `protobuf:"varint,4,opt,name=millisecondsToReceive" json:"millisecondsToReceive,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                  `json:"-"`
	XXX_unrecognized      []byte                    `json:"-"`
	XXX_sizecache         int32                     `json:"-"`
}
...
func (m *TraceEvent_RPCMeta) GetMillisecondsToReceive() uint64 {
	if m != nil && m.MillisecondsToReceive != nil {
		return *m.MillisecondsToReceive
	}
	return 0
}
...
type TraceEvent_MessageMeta struct {
	MessageID            []byte   `protobuf:"bytes,1,opt,name=messageID" json:"messageID,omitempty"`
	Topic                *string  `protobuf:"bytes,2,opt,name=topic" json:"topic,omitempty"`
	MessageSize          *uint64  `protobuf:"varint,3,opt,name=messageSize" json:"messageSize,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TraceEvent_MessageMeta) GetMessageSize() uint64 {
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
...
func (m *TraceEvent_RPCMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MillisecondsToReceive != nil {
		i = encodeVarintTrace(dAtA, i, uint64(*m.MillisecondsToReceive))
		i--
		dAtA[i] = 0x20
	}
	if m.Control != nil {
...
func (m *TraceEvent_RPCMeta) Size() (n int) {
	...
	if m.MillisecondsToReceive != nil {
		n += 1 + sovTrace(uint64(*m.MillisecondsToReceive))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TraceEvent_RPCMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MillisecondsToReceive", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
