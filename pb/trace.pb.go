...
type TraceEvent_ControlMeta struct {
	...
	Iannounce            []*TraceEvent_ControlIAnnounceMeta `protobuf:"bytes,6,rep,name=iannounce" json:"iannounce,omitempty"`
	Ineed                []*TraceEvent_ControlINeedMeta     `protobuf:"bytes,7,rep,name=ineed" json:"ineed,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func (m *TraceEvent_ControlMeta) GetIannounce() []*TraceEvent_ControlIAnnounceMeta {
	if m != nil {
		return m.Iannounce
	}
	return nil
...
func (m *TraceEvent_ControlMeta) GetIneed() []*TraceEvent_ControlINeedMeta {
	if m != nil {
		return m.Ineed
	}
	return nil
...
type TraceEvent_ControlIAnnounceMeta struct {
	Topic                *string  `protobuf:"bytes,1,opt,name=topic" json:"topic,omitempty"`
...
func (m *TraceEvent_ControlIAnnounceMeta) Reset()         { *m = TraceEvent_ControlIAnnounceMeta{} }
func (m *TraceEvent_ControlIAnnounceMeta) String() string { return proto.CompactTextString(m) }
func (*TraceEvent_ControlIAnnounceMeta) ProtoMessage()    {}
func (*TraceEvent_ControlIAnnounceMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 22}
}
func (m *TraceEvent_ControlIAnnounceMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TraceEvent_ControlIAnnounceMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TraceEvent_ControlIAnnounceMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TraceEvent_ControlIAnnounceMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TraceEvent_ControlIAnnounceMeta.Merge(m, src)
}
func (m *TraceEvent_ControlIAnnounceMeta) XXX_Size() int {
	return m.Size()
}
func (m *TraceEvent_ControlIAnnounceMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_TraceEvent_ControlIAnnounceMeta.DiscardUnknown(m)
}

var xxx_messageInfo_TraceEvent_ControlIAnnounceMeta proto.InternalMessageInfo

func (m *TraceEvent_ControlIAnnounceMeta) GetTopic() string {
	if m != nil && m.Topic != nil {
		return *m.Topic
	}
	return ""
...
func (m *TraceEvent_ControlIAnnounceMeta) GetMessageID() []byte {
	if m != nil {
		return m.MessageID
	}
	return nil
...
type TraceEvent_ControlINeedMeta struct {
	MessageID            []byte   `protobuf:"bytes,1,opt,name=messageID" json:"messageID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *TraceEvent_ControlINeedMeta) Reset()         { *m = TraceEvent_ControlINeedMeta{} }
func (m *TraceEvent_ControlINeedMeta) String() string { return proto.CompactTextString(m) }
func (*TraceEvent_ControlINeedMeta) ProtoMessage()    {}
func (*TraceEvent_ControlINeedMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 23}
}
func (m *TraceEvent_ControlINeedMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TraceEvent_ControlINeedMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TraceEvent_ControlINeedMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TraceEvent_ControlINeedMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TraceEvent_ControlINeedMeta.Merge(m, src)
}
func (m *TraceEvent_ControlINeedMeta) XXX_Size() int {
	return m.Size()
}
func (m *TraceEvent_ControlINeedMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_TraceEvent_ControlINeedMeta.DiscardUnknown(m)
}

var xxx_messageInfo_TraceEvent_ControlINeedMeta proto.InternalMessageInfo

func (m *TraceEvent_ControlINeedMeta) GetMessageID() []byte {
	if m != nil {
		return m.MessageID
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TraceEvent_ControlIAnnounceMeta)(nil), "pubsub.pb.TraceEvent.ControlIAnnounceMeta")
	proto.RegisterType((*TraceEvent_ControlINeedMeta)(nil), "pubsub.pb.TraceEvent.ControlINeedMeta")
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
...
func (m *TraceEvent_ControlMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Ineed) > 0 {
		for iNdEx := len(m.Ineed) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Ineed[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.Iannounce) > 0 {
		for iNdEx := len(m.Iannounce) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Iannounce[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TraceEvent_ControlIAnnounceMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TraceEvent_ControlIAnnounceMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TraceEvent_ControlIAnnounceMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TraceEvent_ControlINeedMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TraceEvent_ControlINeedMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TraceEvent_ControlINeedMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TraceEvent_ControlMeta) Size() (n int) {
	...
	if len(m.Iannounce) > 0 {
		for _, e := range m.Iannounce {
			l = e.Size()
			n += 1 + l + sovTrace(uint64(l))
		}
	}
	if len(m.Ineed) > 0 {
		for _, e := range m.Ineed {
			l = e.Size()
			n += 1 + l + sovTrace(uint64(l))
		}
	}
...
func (m *TraceEvent_ControlIAnnounceMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TraceEvent_ControlINeedMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TraceEvent_ControlMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Iannounce", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Iannounce = append(m.Iannounce, &TraceEvent_ControlIAnnounceMeta{})
			if err := m.Iannounce[len(m.Iannounce)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ineed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Ineed = append(m.Ineed, &TraceEvent_ControlINeedMeta{})
			if err := m.Ineed[len(m.Ineed)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TraceEvent_ControlIAnnounceMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ControlIAnnounceMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ControlIAnnounceMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TraceEvent_ControlINeedMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ControlINeedMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ControlINeedMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
